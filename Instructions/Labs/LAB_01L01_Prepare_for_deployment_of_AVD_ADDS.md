...
1. **Azure Pass - 스폰서쉽 | 사용량 + 할당량** 블레이드에서 **지역**을 선택하고, 드롭다운 목록에서 이 랩에 사용할 Azure 지역 이름 옆에 있는 확인란을 선택합니다. 그리고 **적용**을 선택하고 **컴퓨팅** 항목이 **지역** 항목 왼쪽의 드롭다운 목록에 나타나는지 확인한 다음, 검색창에 **표준 DSv3**을 입력합니다. 

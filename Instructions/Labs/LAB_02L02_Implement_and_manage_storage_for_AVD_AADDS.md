...
# <a name="lab---implement-and-manage-storage-for-avd-azure-ad-ds"></a>랩 - AVD용 스토리지 구현 및 관리(Azure AD DS)
...
### <a name="exercise-1-configure-azure-files-to-store-profile-containers-for-azure-virtual-desktop"></a>연습 1: Azure Virtual Desktop용 프로필 컨테이너를 저장하도록 Azure Files 구성
...
#### <a name="task-1-create-an-azure-storage-account"></a>작업 1: Azure Storage 계정 만들기
...
1. **az140-cl-vm11a** Azure VM에 연결된 원격 데스크톱 세션 내에서 Microsoft Edge를 시작하고 [Azure Portal](https://portal.azure.com)로 이동합니다. 그런 다음, **aadadmin1** 사용자 계정의 사용자 계정 이름 및 이 계정을 만들 때 설정한 암호를 제공하여 로그인합니다.
...
#### <a name="task-2-create-an-azure-files-share"></a>작업 2: Azure Files 공유 만들기
...
#### <a name="task-3-enable-azure-ad-ds-authentication-for-the-azure-storage-account"></a>작업 3: Azure Storage 계정에 대해 Azure AD DS 인증을 사용하도록 설정
...
#### <a name="task-4-configure-the-azure-files-rbac-based-permissions"></a>작업 4: Azure Files RBAC 기반 권한 구성
...
1. **구성원 선택** 블레이드의 **텍스트 선택** 상자에 **az140-wvd-ausers**를 입력한 다음, **선택**을 클릭합니다.
...
#### <a name="task-5-configure-the-azure-files-directory-and-file-level-permissions"></a>작업 5: Azure Files 디렉터리 및 파일 수준 권한 구성

...
# <a name="lab---implement-and-manage-storage-for-avd-ad-ds"></a>랩 - AVD용 스토리지 구현 및 관리(AD DS)
...
#### <a name="task-3-enable-ad-ds-authentication-for-the-azure-storage-account"></a>작업 3: Azure Storage 계정에 대해 AD DS 인증을 사용하도록 설정 
...
#### <a name="task-5-configure-the-azure-files-file-system-permissions"></a>작업 5: Azure Files 파일 시스템 권한 구성

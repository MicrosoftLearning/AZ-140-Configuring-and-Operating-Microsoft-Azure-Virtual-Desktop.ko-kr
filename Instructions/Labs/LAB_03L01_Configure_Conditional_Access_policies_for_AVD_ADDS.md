...
# <a name="lab---configure-conditional-access-policies-for-wvd-ad-ds"></a>랩 - WVD용 조건부 액세스 정책 구성(AD DS)
...
- Azure Virtual Desktop에 대한 Azure AD(Azure Active Directory) 기반 조건부 액세스 준비
- Azure Virtual Desktop에 대한 Azure AD 기반 조건부 액세스 구현
...
### <a name="exercise-1-prepare-for-azure-ad-based-conditional-access-for-azure-virtual-desktop"></a>연습 1: Azure Virtual Desktop용 Azure AD 기반 조건부 액세스 준비
...
#### <a name="task-1-configure-azure-ad-premium-p2-licensing"></a>작업 1: Azure AD Premium P2 라이선스 구성
...
#### <a name="task-2-configure-azure-ad-multi-factor-authentication-mfa"></a>작업 2: Azure AD MFA(Multi-Factor Authentication) 구성
...
1. **ID 보호 | MFA 등록 정책** 블레이드에서 **다단계 인증 등록 정책**의 **할당** 섹션에서 **모든 사용자**를 클릭합니다. 그런 다음, **포함** 탭에서 **개인 및 그룹 선택** 옵션을 클릭하고 **사용자 선택**에서 **aduser5**를 클릭한 후에 **선택**을 클릭합니다. 그 후에 블레이드 아래쪽에서 **정책 적용** 스위치를 **켜기**로 설정하고 **저장**을 클릭합니다.

#### <a name="task-3-register-a-user-for-azure-ad-mfa"></a>작업 3: Azure AD MFA용 사용자 등록
...
#### <a name="task-4-configure-hybrid-azure-ad-join"></a>작업 4: 하이브리드 Azure AD 조인 구성
...
6. **Microsoft Azure Active Directory Connect** 창의 **AD Azure에 연결** 페이지에서 이전 연습에서 만든 **aadsyncuser** 사용자 계정의 자격 증명을 사용하여 인증하고 **다음**을 선택합니다.  
   ...
   > **참고**: 이 랩의 앞부분에서 기록한 **aadsyncuser** 계정의 userPrincipalName 속성을 제공하고 이 사용자 계정을 만들 때 설정한 암호를 지정합니다. 
...
#### <a name="task-5-trigger-azure-ad-connect-delta-synchronization"></a>작업 5: Azure AD Connect 델타 동기화 트리거
...
### <a name="exercise-2-implement-azure-ad-based-conditional-access-for-azure-virtual-desktop"></a>연습 2: Azure Virtual Desktop용 Azure AD 기반 조건부 액세스 구현
...
#### <a name="task-1-create-an-azure-ad-based-conditional-access-policy-for-all-azure-virtual-desktop-connections"></a>작업 1: 모든 Azure Virtual Desktop 연결용 Azure AD 기반 조건부 액세스 정책 만들기
...
1. **조건부 액세스 \| 정책** 블레이드의 도구 모음에서 **+ 새 정책**을 클릭하고 바로 가기 메뉴에서 **새 정책 만들기**를 선택합니다.
1. **새로 만들기** 블레이드에서 다음 설정을 구성합니다.
   ...
   - **할당** 섹션에서 **클라우드 앱 또는 작업**을 클릭하고 **이 정책을 적용할 항목 선택** 스위치에서 **클라우드 앱** 옵션이 선택되어 있는지 확인합니다. 그런 다음, **앱 선택** 옵션을 클릭하고 **선택** 블레이드에서 **Azure Virtual Desktop** 항목 옆의 체크박스를 선택한 후에 **선택**을 클릭합니다. 
...
#### <a name="task-2-test-the-azure-ad-based-conditional-access-policy-for-all-azure-virtual-desktop-connections"></a>작업 2: 모든 Azure Virtual Desktop 연결용 Azure AD 기반 조건부 액세스 정책 테스트
...
#### <a name="task-3-modify-the-azure-ad-based-conditional-access-policy-to-exclude-hybrid-azure-ad-joined-computers-from-the-mfa-requirement"></a>작업 3: Azure AD 기반 조건부 액세스 정책을 수정하여 MFA 요구 사항에서 하이브리드 Azure AD 조인 컴퓨터 제외
...
#### <a name="task-4-test-the-modified-azure-ad-based-conditional-access-policy"></a>작업 4: 수정된 Azure AD 기반 조건부 액세스 정책 테스트
...
### <a name="exercise-3-stop-and-deallocate-azure-vms-provisioned-and-used-in-the-lab"></a>연습 3: 랩에서 프로비전 및 사용한 Azure VM 중지 및 할당 취소
